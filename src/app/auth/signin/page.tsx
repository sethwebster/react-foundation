    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-6">
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center overflow-hidden rounded-full bg-white/10 ring-1 ring-white/15">
            <Image
              src="/react-logo.svg"
        ...
        {/* Sign In Options */}
        <div className="space-y-4 rounded-3xl border border-white/10 bg-slate-900/60 p-8">
          {/* GitHub */}
          <button
