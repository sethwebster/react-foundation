    ...
    <div className="p-6 md:p-8 max-w-6xl mx-auto">
      ...
      <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 mb-6">
        ...
        <ul className="text-xs text-muted-foreground space-y-1 list-disc list-inside">
          ...
          <li><strong>MDX Loader:</strong> ~15 docs from public-context/</li>
          <li><strong>Pages Loader:</strong> 7 pages (fetches live rendered HTML from site)</li>
          <li><strong>Communities Loader:</strong> ~65 React communities from Redis</li>
          <li><strong>Libraries Loader:</strong> 32 tracked React ecosystem libraries</li>
          ...
          <li><strong>Total:</strong> ~550-650 chunks of comprehensive knowledge</li>
          <li><strong>Automatic:</strong> Gets latest page content every ingestion</li>
