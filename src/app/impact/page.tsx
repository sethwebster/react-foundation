      ...
      <div className="mx-auto flex max-w-6xl flex-col px-6 pb-24 sm:px-8 lg:px-12">
        <main className="flex flex-col gap-20">
          ...
          <ScrollReveal animation="fade-up">
            <section className="scroll-mt-32 space-y-8 rounded-3xl border border-white/10 bg-gradient-to-br from-emerald-500/10 via-cyan-500/10 to-blue-500/10 p-12">
              ...
              <div className="grid gap-4 pt-8 sm:grid-cols-2 lg:grid-cols-3">
                <div className="space-y-2 rounded-2xl border border-white/10 bg-white/[0.03] p-6 text-center">
                  <div className="text-2xl">💰</div>
                  <h3 className="font-semibold text-white">Revenue Details</h3>
                ...
                <div className="space-y-2 rounded-2xl border border-white/10 bg-white/[0.03] p-6 text-center">
                  <div className="text-2xl">👥</div>
                  <h3 className="font-semibold text-white">Maintainer Funding</h3>
                  <p className="text-sm text-white/60">
                ...
                <div className="space-y-2 rounded-2xl border border-white/10 bg-white/[0.03] p-6 text-center">
                  <div className="text-2xl">📚</div>
                  <h3 className="font-semibold text-white">Education Initiatives</h3>
                  <p className="text-sm text-white/60">
            ...
            <section className="scroll-mt-32 space-y-8 rounded-3xl border border-white/10 bg-slate-900/60 p-12">
              ...
              <div className="grid gap-6 pt-6 lg:grid-cols-3">
                ...
                <div className="space-y-4">
                  ...
                  <h3 className="text-xl font-semibold text-white">Score Calculation</h3>
                  <p className="text-sm leading-relaxed text-white/70">
                ...
                <div className="space-y-4">
                  ...
                  <h3 className="text-xl font-semibold text-white">Fund Distribution</h3>
                  <p className="text-sm leading-relaxed text-white/70">
