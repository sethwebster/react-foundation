	...
	return (
		<Panel tone="cyan" labelledBy="hero-title" className="flex min-h-[72vh] flex-col">
			...
			<div className="relative z-[1] mt-auto pt-16 md:pt-[88px]">
				<PanelEyebrow as="p">Community-driven · Transparent · Impactful</PanelEyebrow>
				<h1
					id="hero-title"
					className="mt-4 max-w-[14ch] text-[clamp(40px,5.2vw,72px)] font-semibold leading-[1.04] tracking-[-0.02em] text-[#16181D]"
				>
